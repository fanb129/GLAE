...
def main(data_loader_dict, args, optim_config, cuda, one_subject, seed=3):
    ...
    if args.dataset_name == 'seed3':
        ...
        iteration = 3
    acc = trainDMMR(data_loader_dict, optim_config, cuda, args, iteration, one_subject)
    return acc
...
if __name__ == '__main__':
    ...
    args.seed3_path = "/home/fb/src/dataset/SEED/ExtractedFeatures/"
    # args.seed4_path = "../eeg_data/eeg_feature_smooth/"
    args.seed4_path = "/home/nise-emo/nise-lab/dataset/public/SEED_IV/eeg_feature_smooth/"
    if cuda:
        args.num_workers_train = 8
        args.num_workers_test = 4
    else:
