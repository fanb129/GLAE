...
if __name__ == "__main__":
    ...
    parser.add_argument("--time_steps", type=int, default=30)  # 你之前seed3用30
    ...
    parser.add_argument("--cls_classes", type=int, default=3)
