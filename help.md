...
setsid nohup python -u lstm_dann_glae/main.py --dataset_name="seed3" --step2 --cuda="0" > lstm_dann_glae/seed3_step2.log 2>&1 &

// 3. Run Full Pipeline (Step 1 + Step 2 Sequentially)
// Recommended for clean run
// Output: lstm_dann_glae/seed3_full.log
setsid nohup python -u lstm_dann_glae/main.py --dataset_name="seed3" --step1 --step2 --cuda="0" > lstm_dann_glae/seed3_full.log 2>&1 &
...
// 3. Run Full Pipeline (Step 1 + Step 2 Sequentially)
setsid nohup python -u lstm_dann_glae/main.py --dataset_name="seed4" --step1 --step2 --cuda="3" > lstm_dann_glae/seed4_full.log 2>&1 &